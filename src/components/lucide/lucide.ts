 ...
 *
 * This file maps alias names to their corresponding icon names.
 * Generated automatically from Lucide icon JSON files.
 *
...
/**
 * Type for all available alias names
 */
