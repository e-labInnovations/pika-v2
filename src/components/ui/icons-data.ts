 ...
 * categories, and tags. Generated automatically from icon JSON files.
 *
...
/**
 * Get all unique categories from the icons data
 */
export function getAllCategories(): string[] {
  return Array.from(new Set(iconsData.flatMap((icon) => icon.categories))).sort();
}

/**
 * Get all unique tags from the icons data
 */
export function getAllTags(): string[] {
  return Array.from(new Set(iconsData.flatMap((icon) => icon.tags))).sort();
}
...
export function getIconsByCategory(category: string): IconData[] {
  return iconsData.filter((icon) => icon.categories.includes(category));
}

/**
 * Find icons by tag
 */
export function getIconsByTag(tag: string): IconData[] {
  return iconsData.filter((icon) => icon.tags.includes(tag));
}
...
/**
 * Statistics about the icons data
 */
